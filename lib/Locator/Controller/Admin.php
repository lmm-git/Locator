...
class Locator_Controller_Admin extends Zikula_AbstractController
{
	...
	{
		$this->redirect(ModUtil::url($this->name, 'admin', 'toggleLayers'));
	}
	 ...
	 * @version 1.0
	 */
	public function toggleLayers()
	{
		if(!SecurityUtil::checkPermission('Locator::', '::', ACCESS_ADMIN))
			return LogUtil::registerPermissionError();
		
		$form = FormUtil::newForm($this->name, $this);
		return $form->execute('Admin/ToggleLayers.tpl', new Locator_Form_Handler_Admin_ToggleLayers());
	}
	...
	public function addLayer()
	{
		...
		$form = FormUtil::newForm($this->name, $this);
		return $form->execute('Admin/AddLayer.tpl', new Locator_Form_Handler_Admin_AddLayer());
	}
